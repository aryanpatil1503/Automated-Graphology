...
if os.path.isfile("label_list3"):
    print("Info: label_list found.")
    # =================================================================
    with open("label_list3", "r") as labels:
        for line in labels:
            content = line.split()
    ...
    """print("Classifier 1 accuracy: ", accuracy_score(
        clf1.predict(X_test), y_test))
    print(classification_report(clf1.predict(X_train), y_train))"""
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        X_t3, y_t3, test_size=.20, random_state=32)
    clf3 = SVC(kernel='rbf')
    clf3.fit(X_train, y_train)
    """print("Classifier 3 accuracy: ", accuracy_score(
        clf3.predict(X_test), y_test))
    print(classification_report(clf3.predict(X_train), y_train))"""
    ...
    print(classification_report(clf4.predict(X_train), y_train))"""
    ...
    print(classification_report(clf5.predict(X_train), y_train))"""
    ...
    print(classification_report(clf6.predict(X_train), y_train))"""
    ...
    print(classification_report(clf7.predict(X_train), y_train))"""
    ...
    print("\n")
    print(classification_report(clf8.predict(X_train), y_train))"""
    # =================================================================================================
...
#from sklearn.model_selection import train_test_split
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        X_t4, y_t4, test_size=0.30)

    from sklearn.neighbors import KNeighborsClassifier

    clf9 = KNeighborsClassifier(n_neighbors=5)
    clf9.fit(X_train, y_train)
    """print("Classifier 4 KNN accuracy: ",
          accuracy_score(clf9.predict(X_test), y_test))"""

    from sklearn.model_selection import train_test_split

    X_train, X_test, y_train, y_test = train_test_split(
        X_t5, y_t5, test_size=0.30)

    from sklearn.neighbors import KNeighborsClassifier

    clf10 = KNeighborsClassifier(n_neighbors=5)
    clf10.fit(X_train, y_train)
    """print("Classifier 5 KNN accuracy: ",
    ...
    """print("Classifier 1 RF accuracy: ", accuracy_score(
        clf11.predict(X_test), y_test))"""

    X_train, X_test, y_train, y_test = train_test_split(
        X_t2, y_t2, test_size=0.30)
    clf12 = RandomForestClassifier(criterion="gini", n_estimators=10)
    clf12.fit(X_train, y_train)
    """print("Classifier 2 RF accuracy: ", accuracy_score(
        clf12.predict(X_test), y_test))"""

    X_train, X_test, y_train, y_test = train_test_split(
        X_t3, y_t3, test_size=0.30)
    clf13 = RandomForestClassifier(criterion="gini", n_estimators=10)
    clf13.fit(X_train, y_train)
    """print("Classifier 3 RF accuracy: ", accuracy_score(
        clf13.predict(X_test), y_test))"""

    X_train, X_test, y_train, y_test = train_test_split(
        X_t4, y_t4, test_size=0.30)
    clf14 = RandomForestClassifier(criterion="gini", n_estimators=10)
    clf14.fit(X_train, y_train)
    """print("Classifier 4 RF accuracy: ", accuracy_score(
        clf14.predict(X_test), y_test))"""

    X_train, X_test, y_train, y_test = train_test_split(
        X_t5, y_t5, test_size=0.30)
    clf15 = RandomForestClassifier(criterion="gini", n_estimators=10)
    clf15.fit(X_train, y_train)
    """print("Classifier 5 RF accuracy: ", accuracy_score(
        clf15.predict(X_test), y_test))
    print(classification_report(clf15.predict(X_train), y_train))"""
    # ================================================================================================
    ...
    while True:
        ...
        print("Mental Strength, Will Power and Emotional Depth: ",
              clf2.predict([[letter_size, pen_pressure]]))
        print("Modesty: ", clf3.predict([[letter_size, top_margin]]))
        print("Personal Harmony, Flexibility and Openness to Criticism: ",
        ...
        print("Weaker Interactive skills: ", clf7.predict(
