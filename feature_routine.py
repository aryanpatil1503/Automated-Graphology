...
if os.path.isfile("feature_list3"):
    print("Error: feature_list already exists.")

elif os.path.isfile("C:\\Users\\aryan\\Desktop\\TE SEM5\\Seminar\\project\\virtual_env\\raw_feature_list3"):
    print("Info: raw_feature_list found.")
    with open("C:\\Users\\aryan\\Desktop\\TE SEM5\\Seminar\\project\\virtual_env\\raw_feature_list3", "r") as raw_features, open("feature_list3", "a") as features:
